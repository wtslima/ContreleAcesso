...
namespace ControleAcesso.Teste.Servicos
{
    ...
    public class UsuarioExternoTestes
    {
        ...
        [TestCase("whey2@inmetro.gov.br", 8688, "Whey Protein2", "SERVIR", "AUTENTIC" )]
        public void CriarUsuarioExterno(string login, int pessoaId,  string nome, string codigoSistema, string codigoPerfil)
        {
            var usuario = UsuarioExternoServico.NovaInstancia.CriarUsuario(login, pessoaId, nome, codigoSistema, codigoPerfil);
