...
namespace ControleAcesso.Teste.Servicos
{
	...
	public class SistemaTestes
	{
		...
		public void ValidarToken_Sucesso() {
			Assert.IsTrue(SistemaServico.Instancia.ValidarToken("9168cc74d8be8fb3bc155dc2ff3fd332", "sesis-40rc.inmetro.local"));
		}
		
		[Test]
		public void ValidarToken_Falha_TokenInvalido() {
			try {
				SistemaServico.Instancia.ValidarToken("9168cc74d8be8fb3bc155dc2ff3fd332", "sesis-rc.inmetro.local");
		...
		public void ValidarToken_Falha_TokenValidoComIPInvalido() {
			SistemaServico.Instancia.ValidarToken("8827fa9e29730dd539a51a2a71004a45", "1.0.0.1");
		}
		#endregion
