...
namespace ControleAcesso.Dominio.Aplicacao.Servicos
{
    public class UsuarioExternoServico : Servico<UsuarioExterno>
    {
        ...
        public UsuarioExterno CriarUsuario(string login, int pessoaId, string nome, string codigoSistema, string codigoPerfil, string senha)
        {
            ...
            if (usuarioExternoCadastrado == null)
            {
                ...
                novoUsuarioExterno.AdicionarSenha(new UsuarioExternoSenha(login, senha));
        ...
        public void DesativarUsuario(string loginUsuarioExterno)
        {
            Servico<UsuarioExternoSenha>.Instancia.Excluir(s => s.Login.ToLower().Equals(loginUsuarioExterno.ToLower().Trim()));
        }
        ...
        public string SolicitarSenhaTemporaria(string loginUsuarioExterno, DateTime? dataExpiracao = null)
        {
            ...
            Servico<UsuarioExternoSenha>.Instancia.Excluir(s => s.Login.ToLower().Equals(loginUsuarioExterno.ToLower().Trim()) && s.Tipo.Equals("T"));
        ...
        {
            Servico<UsuarioExternoSenha>.Instancia.Excluir(s => s.Login.Equals(login) && s.Tipo.Trim() == "T");
