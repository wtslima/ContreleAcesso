...
namespace ControleAcesso.Teste.Unitarios
{
	...
	public class SistemaTestes
	{
		...
		public void AdicionarERemoverIPs_Sucesso() {
			...
			sistema.AdicionarIpServidorOrigem("sesis-35rc.inmetro.local");
			...
			var retorno = sistema.AdicionarIpServidorOrigem("sesis-35rc.inmetro.local");
			Assert.AreEqual(sistema.ServidoresOrigem.Count(), 3);
			
			sistema.RemoverIpServidorOrigem("sesis-35rc.inmetro.local");
