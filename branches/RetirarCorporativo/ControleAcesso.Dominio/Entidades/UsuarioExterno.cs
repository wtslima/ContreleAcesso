...
namespace ControleAcesso.Dominio.Entidades
{
	public class UsuarioExterno : Controle
	{
        ...
        public IList<UsuarioExternoSistemaPerfil> _perfis;
        ...
        public virtual int SenhaTemporariaIndex
	    {
	        get { return _senhaTemporariaIndex; }
	        set { _senhaTemporariaIndex = value; }
	    }

        public virtual int SenhaIndex
	    {
	        get { return _senhaIndex; }
	        set { _senhaIndex = value; }
	    }
