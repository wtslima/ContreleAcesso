...
namespace ControleAcesso.Dominio.Entidades
{
	public class Sistema : Controle
	{
		...
		public virtual IEnumerable<ServidorOrigem> ServidoresOrigem {
		    ...
		    set { _servidoresOrigem = new HashSet<ServidorOrigem>(value); }
		}
		...
		public virtual bool AdicionarIpServidorOrigem(string servidorOrigem) {
			...
			var ipServidor = new ServidorOrigem(Codigo, _servidoresOrigem.Count + 1, servidorOrigem);
		...
		public virtual bool RemoverPerfilAcesso(string codigoPerfil) {
			return _perfisAcesso.RemoveWhere(p => p.Codigo.Trim().Equals(codigoPerfil)) > 0;
		}
