    ...
    public class AutenticacaoServico : IAutenticacaoServico
    {
        ...
        public List<Usuario> ObterTodosUsuarios(string token, FiltroObterTodosUsuariosEnum filtro, bool filtrarPorSistema)
        {
            ...
            try
            {
                if (SistemaServico.ValidarToken(token))
                {
                    ...
                    var sistema = SistemaServico.Buscar(s => s.Codigo.Equals(origem.CodigoSistema)).FirstOrDefault();
        ...
        public void CriarSenha(string token, string login, string senha)
        {
            try
            {
                if (SistemaServico.ValidarToken(token))
                {
                    UsuarioExternoServico.CriarSenha(login, senha);
                }
                else
                {
        ...
        public List<String> PerfisSistema(string token)
        {
            ...
            try
            {
                ...
                if (token != null)
                {
                    var perfis = SistemaServico.Buscar(s => s.Codigo.Equals(objToken.CodigoSistema)).FirstOrDefault().PerfisAcesso;
        ...
        public List<Perfil> ObterPerfisSistema(string token)
        {
            ...
            try
            {
                ...
                if (token != null)
                {
                    var sistema = SistemaServico.Buscar(s => s.Codigo.Equals(objToken.CodigoSistema)).FirstOrDefault();
        ...
        public RetornoVerificacaoServico VerificacaoPeriodicaServico()
        {
            ...
            try
            {
                retorno.Consulta = ((SistemaServico.Buscar(x => x.Ativo).Any()));
            }
            catch (Exception ex)
            {
