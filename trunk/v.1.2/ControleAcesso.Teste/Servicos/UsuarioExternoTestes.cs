...
namespace ControleAcesso.Teste.Servicos
{
    ...
    public class UsuarioExternoTestes
    {
        ...
        [TestCase("whey200@inmetro.gov.br", 1, "Whey Protein2", "SERVIR", "AUTENTIC", "123" )]
        public void CriarUsuarioExterno(string login, int pessoaId,  string nome, string codigoSistema, string codigoPerfil, string senha)
        {
            var usuario = UsuarioExternoServico.NovaInstancia.CriarUsuario(login, pessoaId, nome, codigoSistema, codigoPerfil, senha);
